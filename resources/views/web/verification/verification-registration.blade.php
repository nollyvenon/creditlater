                    ...
                    <form action="{{ url('registration-form/'.Session::get('user')['id']) }}" method="post" enctype="multipart/form-data"class="theme-form">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="first_name" placeholder="Enter Your name" value="{{ old('first_name') }}" required="">
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phone" placeholder="Enter your number" value="{{ old('phone') }}" required="">
                            </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="national_id" placeholder="NIN" value="{{ old('national_id') }}" required="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="occupation" placeholder="Occupation" value="{{ old('ccupation') }}" required="">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <textarea class="form-control" placeholder="Write Your Message" name="address" rows="2"  value="{{ old('address') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- user form start -->
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <label for="name">First Name</label>
                                        <input type="text" class="form-control" name="guarantor_first_name" placeholder="Enter Your name" value="{{ old('guarantor_first_name') }}" required="">
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <label for="email">Last Name</label>
                                        <input type="text" class="form-control" name="guarantor_last_name" placeholder="Last Name" value="{{ old('guarantor_last_name') }}" required="">
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <label for="review">Phone number</label>
                                        <input type="text" class="form-control" name="guarantor_phone" placeholder="Enter your number" value="{{ old('guarantor_phone') }}" required="">
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="guarantor_date_of_birth" placeholder="Date of birth" value="{{ old('guarantor_date_of_birth') }}" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <label for="nin">Nation ID number</label>
                                            <input type="text" class="form-control" name="guarantor_national_id" placeholder="NIN" value="{{ old('guarantor_national_id') }}" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <label for="occupation">Occupation</label>
                                            <input type="text" class="form-control" name="guarantor_occupation" placeholder="occupation" value="{{ old('guarantor_occupation') }}" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="guarantor_relationship" placeholder="Relationship with buyer" value="{{ old('guarantor_relationship') }}" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div>
                                            ...
                                            @endif
                                            <label for="review">Address</label>
                                            <textarea class="form-control" placeholder="Write Your Message" name="guarantor_address" rows="2" value="{{ old('guarantor_address') }}"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <a href="{{ url('/account') }}" class="btn btn-normal"> <i class="fa fa-angle-left"></i> <i class="fa fa-angle-left"></i> Back</a>
