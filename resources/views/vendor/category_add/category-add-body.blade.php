                    ...
                    <div class="col-6" style="margin-left: 25%">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('/vendor/category/add') }}" method="post" enctype="multipart/form-data" class="form-horizontal" >
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="text" id="example-email" name="category_name" class="form-control" value="{{ old('category_name') }}" placeholder="Enter category">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-lg-12">
